                            ...
                            <TableBody>
                                {calls && calls.map((row) => (
                                    ...
                                    >
                                        ...
                                        }}>{row.is_archived ? <span className='flex cursor-pointer items-center justify-center bg-teal-50 rounded-md p-2 text-teal-500 '>Archived</span> : <span className='flex cursor-pointer items-center justify-center bg-gray-100 rounded-md p-2 text-gray-500 '>Not Archived</span>}</TableCell>
